...
REGISTRATION_DROPDOWN_LABEL = ENV_TOKENS.get('REGISTRATION_DROPDOWN_LABEL', REGISTRATION_DROPDOWN_LABEL)
REGISTRATION_DROPDOWN_CHOICES = ENV_TOKENS.get('REGISTRATION_DROPDOWN_CHOICES', REGISTRATION_DROPDOWN_CHOICES)
REGISTRATION_DROPDOWN_MISSING_ERROR = ENV_TOKENS.get(
    'REGISTRATION_DROPDOWN_MISSING_ERROR', REGISTRATION_DROPDOWN_MISSING_ERROR
)
