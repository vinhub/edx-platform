# -*- coding: utf-8 -*-
# pylint: disable=invalid-name,missing-docstring,line-too-long,unused-argument
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.dropdown'
        db.add_column('auth_userprofile', 'dropdown',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.dropdown'
        db.delete_column('auth_userprofile', 'dropdown')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'dropdown': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
